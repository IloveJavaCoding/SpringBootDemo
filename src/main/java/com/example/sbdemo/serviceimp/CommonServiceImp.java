...
import com.example.sbdemo.config.Constants;
import com.example.sbdemo.service.CommonService;
...
@Transactional
public class CommonServiceImp<M extends BaseMapper<T>, T> extends ServiceImpl<M, T> implements CommonService<T> {
